...
Непосредственных аналогов по функционалу   для  приложения  в marketplace(магазин приложений) bitrix24, либо эти приложения находятся не в открытом доступе. Части фунционала есть в «заводских» модулях crm, таких как «старт», «сотрудники», однако комплексного решения на данный момент я не обнаружил.
...
<p align="justify">Приложение должно быть максимально универсальным , вне зависимости от конкретного бизнеса. Исключить зависимость от выхода новых версий crm и каких-либо внешних сервисов. </p>
